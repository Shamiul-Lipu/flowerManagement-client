...
interface SearchYearSellProps {
  handleInputChange: FormEventHandler<HTMLFormElement> | undefined;
  setInput: React.Dispatch<React.SetStateAction<string>>;
  input: string;
}

const SearchYearSell: React.FC<SearchYearSellProps> = ({
  handleInputChange,
  setInput,
  input,
}) => {
  return (
    <div className="flex justify-end items-center">
      <form
        ...
        className="tooltip"
        data-tip="Enter year & click search"
        title="Enter year & click search"
      >
        <div className="flex">
          <div className="relative w-full overflow-hidden rounded-lg border-2 border-[#1C4336] text-[#1C4336] md:min-w-[380px] lg:min-w-[440px]">
            <input
              ...
              placeholder="Enter a year ex: 2023"
              pattern="\d{4}"
